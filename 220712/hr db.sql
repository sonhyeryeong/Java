...
ADD CONSTRAINT `fk_departments_locations1`
...
ADD CONSTRAINT `fk_employees_jobs1`
  FOREIGN KEY (`JOB_ID`)
  REFERENCES `jobs` (`JOB_ID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_employees_employees1`
...
ADD CONSTRAINT `fk_job_history_employees1`
  FOREIGN KEY (`EMPLOYEE_ID`)
  REFERENCES `employees` (`EMPLOYEE_ID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_job_history_jobs1`
  FOREIGN KEY (`JOB_ID`)
  REFERENCES `jobs` (`JOB_ID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_job_history_departments1`
  FOREIGN KEY (`DEPARTMENT_ID`)
  REFERENCES `departments` (`DEPARTMENT_ID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
